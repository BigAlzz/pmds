# Generated by Django 5.0.2 on 2025-02-26 07:03
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('performance', '0020_remove_gaffinalrating_final_review_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_evidence_file', models.FileField(blank=True, null=True, upload_to='gaf_final_evidence/%Y/%m/%d/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_comments', models.TextField(blank=True)),
                ('employee_evidence', models.TextField(blank=True, help_text='Description of evidence for the rating')),
                ('employee_evidence_file', models.FileField(blank=True, null=True, upload_to='kra_final_evidence/%Y/%m/%d/')),
                ('supervisor_rating', models.IntegerField(blank=True, choices=[(4, 'Performance Significantly Above Expectations (4)'), (3, 'Fully Effective Performance (3)'), (2, 'Performance Not Fully Effective (2)'), (1, 'Unacceptable Performance (1)')], null=True)),
                ('supervisor_comments', models.TextField(blank=True)),
                ('agreed_rating', models.IntegerField(blank=True, choices=[(4, 'Performance Significantly Above Expectations (4)'), (3, 'Fully Effective Performance (3)'), (2, 'Performance Not Fully Effective (2)'), (1, 'Unacceptable Performance (1)')], help_text='Final agreed rating between employee and supervisor', null=True)),
